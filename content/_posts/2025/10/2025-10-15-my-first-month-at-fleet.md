...
Fleet has a [three-day CEO shadow program](https://fleetdm.com/handbook/company/leadership#ceo-shadow-program) for all new hires. I thought it would be boring. Sitting in meetings all day, not contributing, just observing.
...
If my full-time job could be following [Mike](https://www.linkedin.com/in/mikermcneil/) around adding context from the perspective of a former CPE, manager, and customer, I'd jump at it.
...
Even while onboarding, I've been working on a [Fleet AutoPkg processor](https://github.com/kitzy/fleetimporter) and opening feature requests that came out of that work ([#34137](https://github.com/fleetdm/fleet/issues/34137), [#32965](https://github.com/fleetdm/fleet/issues/32965)).
...
Everyone keeps telling me to prioritize my health over the job. Empathy being first in Fleet's [company values](https://fleetdm.com/handbook/company#values) isn't just words. It's how people operate every day.
