        ...
        <div class="speaking-item">
            <div class="speaking-header">
                <h3 class="speaking-title">
                    <a href="https://podcast.macadmins.org/2025/10/28/episode-434-learning-new-lore-with-kitzy/" target="_blank" rel="noopener noreferrer">
                        MacAdmins Podcast - Episode 434: Learning New Lore with Kitzy
                    </a>
                </h3>
                <div class="speaking-meta">
                    <span class="speaking-date">October 28, 2025</span>
                </div>
            </div>
            <p class="speaking-description">
                A conversation about my transition to Fleet, navigating career changes, learning new technical domains, and the art of building institutional knowledge in fast-moving organizations. I shared insights on moving from management back to individual contributor work, embracing curiosity in new technical challenges, and finding balance between ADHD-driven hyperfocus and sustainable work practices.
            </p>
        </div>
